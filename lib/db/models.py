from sqlalchemy import (ForeignKey, Column, Integer, String, Numeric, create_engine)
...
class Medication(Base):
    ...
    patients = relationship('Patient', secondary= 'prescriptions', back_populates= 'medications')
    def __repr__(self):
...
class Patient(Base):
    ...
    medications = relationship('Medication', secondary= 'prescriptions', back_populates= 'patients')
    def __repr__(self):
